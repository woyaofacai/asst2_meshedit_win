...
int OSDText::init(bool use_hdpi) {
  ...
  int len1 = strlen(osdfont_base64_1);
  int len2 = strlen(osdfont_base64_2);
  int len3 = strlen(osdfont_base64_3);
  int len4 = strlen(osdfont_base64_4);
  int len = len1 + len2 + len3 + len4;

  strcpy(osdfont_base64, osdfont_base64_1);
  strcat(osdfont_base64, osdfont_base64_2);
  strcat(osdfont_base64, osdfont_base64_3);
  strcat(osdfont_base64, osdfont_base64_4);
